...
/**
 * An alternative to: string.replaceAll("key1", "value1").replaceAll("key2", "value2")....
 *
 * <p>ReplaceStrings, This class is used to replace multiple strings in a section of text, with high
...
public class EffecientMultipleStringReplacement {
  ...
  /**
   * replace, This replaces multiple strings in a section of text, according to the supplied search
   * and replace definitions. For maximum efficiency, this will automatically choose between two
   * possible replacement algorithms.
   *
   * <p>Performance note: If it is known in advance that the source text is long, then this method
  ...
  /**
   * replace, This replaces multiple strings in a section of text, according to the supplied search
   * strings and replacement strings. For maximum efficiency, this will automatically choose between
   * two possible replacement algorithms.
   *
   * <p>Performance note: If it is known in advance that the source text is short, then this method
   * signature has a very small additional performance advantage over the other method signature.
   * (Although either method signature will still choose the best algorithm.)
   */
  public static String replace(
      final String sourceText,
      final ArrayList<String> searchList,
      final ArrayList<String> replacementList) {
   ...
   */
  private static String replaceUsing_StringUtilsAlgorithm(
      final String sourceText,
      final ArrayList<String> searchList,
      final ArrayList<String> replacementList) {
   ...
   */
  private static String replaceUsing_AhoCorasickAlgorithm(
      final String sourceText, final Map<String, String> searchReplaceDefinitions) {
    ...
    for (final Emit emit : emits) {
      ...
      sb.append(sourceText, prevIndex, matchIndex);
